...
export class QuienesSomosComponent {
  ...
  get2() {
    this.http
      .get<PlaceHolder>(this.url + '/' + this.inputIdGet)
      .subscribe((data) => {
        this.resultadoPeticion = data;
  ...
  get3() {
    this.http.get<PlaceHolder>(this.url + '/' + this.inputIdGet).subscribe({
  ...
  post(){
    this.http.post(this.url , 
    {
      userId: 2,
      id: 200,
      title: 'Nuevo titulo de prueba',
      body: 'Nuevo cuerpo de prueba'
